...
- Lauf: 2026-08-16, Repo-Commit `8955471`
...
|---|---:|---|
| verifiziert | 399 | Ledger-Zeile mit Status `verifiziert` |
...
| `packages/coding-agent/src/cli.ts` | portiert | `crates/notagent/PARITY.md:520` | datei |
| `packages/coding-agent/src/cli/args.ts` | portiert | `crates/notagent/PARITY.md:518` | datei |
| `packages/coding-agent/src/cli/config-selector.ts` | gelesen | `crates/notagent/PARITY.md:167` | datei |
| `packages/coding-agent/src/cli/file-processor.ts` | portiert | `crates/notagent/PARITY.md:527` | datei |
| `packages/coding-agent/src/config.ts` | portiert | `crates/notagent/PARITY.md:364` | datei |
| `packages/coding-agent/src/core/agent-session-runtime.ts` | portiert | `crates/notagent/PARITY.md:516` | datei |
| `packages/coding-agent/src/core/agent-session-services.ts` | portiert | `crates/notagent/PARITY.md:515` | datei |
| `packages/coding-agent/src/core/agent-session.ts` | portiert | `crates/notagent/PARITY.md:504` | datei |
| `packages/coding-agent/src/core/auth-guidance.ts` | gelesen | `crates/notagent/PARITY.md:712` | datei |
| `packages/coding-agent/src/core/auth-storage.ts` | portiert | `crates/notagent/PARITY.md:377` | datei |
| `packages/coding-agent/src/core/bash-executor.ts` | portiert | `crates/notagent/PARITY.md:408` | datei |
| `packages/coding-agent/src/core/export-html/template.css` | unklar | `crates/notagent/PARITY.md:856` | datei |
| `packages/coding-agent/src/core/export-html/template.html` | gelesen | `crates/notagent/PARITY.md:828` | datei |
| `packages/coding-agent/src/core/export-html/template.js` | unklar | `crates/notagent/PARITY.md:856` | datei |
| `packages/coding-agent/src/core/export-html/tool-renderer.ts` | gelesen | `crates/notagent/PARITY.md:827` | datei |
| `packages/coding-agent/src/core/hooks/events.ts` | portiert | `crates/notagent/PARITY.md:448` | datei |
| `packages/coding-agent/src/core/hooks/extension.ts` | gelesen | `crates/notagent/PARITY.md:262` | datei |
| `packages/coding-agent/src/core/hooks/hooks.ts` | portiert | `crates/notagent/PARITY.md:449` | datei |
| `packages/coding-agent/src/core/hooks/payload.ts` | portiert | `crates/notagent/PARITY.md:450` | datei |
| `packages/coding-agent/src/core/hooks/runner.ts` | portiert | `crates/notagent/PARITY.md:451` | datei |
| `packages/coding-agent/src/core/hooks/runtime.ts` | portiert | `crates/notagent/PARITY.md:452` | datei |
| `packages/coding-agent/src/core/http-dispatcher.ts` | portiert | `crates/notagent/PARITY.md:657` | datei |
| `packages/coding-agent/src/core/messages.ts` | portiert | `crates/notagent/PARITY.md:381` | datei |
| `packages/coding-agent/src/core/mini-read/index.ts` | portiert | `crates/notagent/PARITY.md:413` | datei |
| `packages/coding-agent/src/core/mini-read/languages.ts` | portiert | `crates/notagent/PARITY.md:414` | datei |
| `packages/coding-agent/src/core/mini-read/minify-edit.ts` | portiert | `crates/notagent/PARITY.md:412` | datei |
| `packages/coding-agent/src/core/mini-read/minify.ts` | portiert | `crates/notagent/PARITY.md:411` | datei |
| `packages/coding-agent/src/core/modes/cycle.ts` | portiert | `crates/notagent/PARITY.md:435` | datei |
| `packages/coding-agent/src/core/modes/indicator.ts` | portiert | `crates/notagent/PARITY.md:436` | datei |
| `packages/coding-agent/src/core/modes/modes.ts` | portiert | `crates/notagent/PARITY.md:433` | datei |
| `packages/coding-agent/src/core/modes/shells.ts` | portiert | `crates/notagent/PARITY.md:434` | datei |
| `packages/coding-agent/src/core/output-guard.ts` | portiert | `crates/notagent/PARITY.md:535` | datei |
| `packages/coding-agent/src/core/permissions/chain.ts` | portiert | `crates/notagent/PARITY.md:441` | datei |
| `packages/coding-agent/src/core/permissions/coordinator.ts` | portiert | `crates/notagent/PARITY.md:445` | datei |
| `packages/coding-agent/src/core/permissions/extension.ts` | gelesen | `crates/notagent/PARITY.md:256` | datei |
| `packages/coding-agent/src/core/permissions/hook.ts` | portiert | `crates/notagent/PARITY.md:446` | datei |
| `packages/coding-agent/src/core/permissions/policies.ts` | portiert | `crates/notagent/PARITY.md:442` | datei |
| `packages/coding-agent/src/core/permissions/policy.ts` | portiert | `crates/notagent/PARITY.md:440` | datei |
| `packages/coding-agent/src/core/permissions/request.ts` | portiert | `crates/notagent/PARITY.md:444` | datei |
| `packages/coding-agent/src/core/permissions/user-rules.ts` | portiert | `crates/notagent/PARITY.md:443` | datei |
| `packages/coding-agent/src/core/project-trust.ts` | portiert | `crates/notagent/PARITY.md:454` | datei |
| `packages/coding-agent/src/core/resolve-config-value.ts` | portiert | `crates/notagent/PARITY.md:370` | datei |
| `packages/coding-agent/src/core/resource-loader.ts` | portiert | `crates/notagent/PARITY.md:496` | datei |
| `packages/coding-agent/src/core/sdk.ts` | portiert | `crates/notagent/PARITY.md:512` | datei |
| `packages/coding-agent/src/core/session-manager.ts` | portiert | `crates/notagent/PARITY.md:380` | datei |
| `packages/coding-agent/src/core/settings-manager.ts` | portiert | `crates/notagent/PARITY.md:366` | datei |
| `packages/coding-agent/src/core/source-info.ts` | portiert | `crates/notagent/PARITY.md:431` | datei |
| `packages/coding-agent/src/core/todos/render.ts` | portiert | `crates/notagent/PARITY.md:422` | datei |
| `packages/coding-agent/src/core/todos/todos.ts` | portiert | `crates/notagent/PARITY.md:421` | datei |
| `packages/coding-agent/src/core/tools/bash.ts` | portiert | `crates/notagent/PARITY.md:406` | datei |
| `packages/coding-agent/src/core/tools/file-mutation-queue.ts` | portiert | `crates/notagent/PARITY.md:401` | datei |
| `packages/coding-agent/src/core/tools/output-accumulator.ts` | portiert | `crates/notagent/PARITY.md:388` | datei |
| `packages/coding-agent/src/core/tools/path-utils.ts` | portiert | `crates/notagent/PARITY.md:384` | datei |
| `packages/coding-agent/src/core/tools/truncate.ts` | portiert | `crates/notagent/PARITY.md:383` | datei |
| `packages/coding-agent/src/core/trust-manager.ts` | portiert | `crates/notagent/PARITY.md:455` | datei |
| `packages/coding-agent/src/main.ts` | portiert | `crates/notagent/PARITY.md:523` | datei |
| `packages/coding-agent/src/migrations.ts` | portiert | `crates/notagent/PARITY.md:368` | datei |
| `packages/coding-agent/src/modes/index.ts` | portiert | `crates/notagent/PARITY.md:539` | datei |
...
| `packages/coding-agent/src/modes/interactive/components/index.ts` | portiert | `crates/notagent/PARITY.md:596` | datei |
| `packages/coding-agent/src/modes/interactive/interactive-mode.ts` | gelesen | `crates/notagent/PARITY.md:194` | datei |
| `packages/coding-agent/src/modes/interactive/model-search.ts` | portiert | `crates/notagent/PARITY.md:432` | datei |
| `packages/coding-agent/src/modes/interactive/theme/theme-controller.ts` | portiert | `crates/notagent/PARITY.md:577` | datei |
| `packages/coding-agent/src/modes/interactive/theme/theme-schema.json` | gelesen | `crates/notagent/PARITY.md:68` | datei |
| `packages/coding-agent/src/modes/rpc/rpc-mode.ts` | portiert | `crates/notagent/PARITY.md:544` | datei |
| `packages/coding-agent/src/modes/rpc/rpc-types.ts` | portiert | `crates/notagent/PARITY.md:543` | datei |
| `packages/coding-agent/src/package-manager-cli.ts` | portiert | `crates/notagent/PARITY.md:808` | datei |
| `packages/coding-agent/src/rpc-entry.ts` | portiert | `crates/notagent/PARITY.md:521` | datei |
| `packages/coding-agent/src/utils/abort.ts` | portiert | `crates/notagent/PARITY.md:375` | datei |
| `packages/coding-agent/src/utils/ansi.ts` | portiert | `crates/notagent/PARITY.md:374` | datei |
| `packages/coding-agent/src/utils/child-process.ts` | portiert | `crates/notagent/PARITY.md:407` | datei |
| `packages/coding-agent/src/utils/frontmatter.ts` | portiert | `crates/notagent/PARITY.md:438` | datei |
| `packages/coding-agent/src/utils/html.ts` | portiert | `crates/notagent/PARITY.md:429` | datei |
| `packages/coding-agent/src/utils/image-convert.ts` | portiert | `crates/notagent/PARITY.md:398` | datei |
| `packages/coding-agent/src/utils/image-process.ts` | portiert | `crates/notagent/PARITY.md:398` | datei |
| `packages/coding-agent/src/utils/image-resize-core.ts` | portiert | `crates/notagent/PARITY.md:398` | datei |
| `packages/coding-agent/src/utils/image-resize.ts` | portiert | `crates/notagent/PARITY.md:398` | datei |
| `packages/coding-agent/src/utils/management-http.ts` | portiert | `crates/notagent/PARITY.md:392` | datei |
| `packages/coding-agent/src/utils/mime.ts` | portiert | `crates/notagent/PARITY.md:397` | datei |
| `packages/coding-agent/src/utils/paths.ts` | portiert | `crates/notagent/PARITY.md:372` | datei |
| `packages/coding-agent/src/utils/shell.ts` | portiert | `crates/notagent/PARITY.md:371` | datei |
| `packages/coding-agent/src/utils/syntax-highlight.ts` | portiert | `crates/notagent/PARITY.md:428` | datei |
| `packages/coding-agent/src/utils/tools-manager.ts` | portiert | `crates/notagent/PARITY.md:391` | datei |
...
|---|---:|---|---|---:|
| `crates/notagent/PARITY.md` | 393 | offen | unklar | 1 |
| `crates/notagent/PARITY.md` | 394 | offen | unklar | 1 |
| `crates/notagent/PARITY.md` | 423 | offen | unklar | 1 |
| `crates/notagent/PARITY.md` | 447 | nativ ersetzt | unklar | 1 |
| `crates/notagent/PARITY.md` | 453 | nativ ersetzt | unklar | 1 |
| `crates/notagent/PARITY.md` | 533 | offen (Task 13) | unklar | 1 |
| `crates/notagent/PARITY.md` | 534 | teilweise entfallen, Rest Task 13 | portiert | 1 |
| `crates/notagent/PARITY.md` | 556 | teilportiert (Scheibe 1 von 5) | unklar | 1 |
| `crates/notagent/PARITY.md` | 581 | übernommen | unklar | 1 |
| `crates/notagent/PARITY.md` | 596 | teilweise portiert | portiert | 1 |
| `crates/notagent/PARITY.md` | 657 | teilweise portiert | portiert | 1 |
| `crates/notagent/PARITY.md` | 855 | teilportiert | unklar | 1 |
| `crates/notagent/PARITY.md` | 856 | übernommen | unklar | 3 |
| `crates/notagent/PARITY.md` | 862 | nachgezogen | unklar | 1 |
| `crates/notagent/PARITY.md` | 903 | offen (C) | unklar | 1 |
| `crates/notagent/PARITY.md` | 904 | offen (C) | unklar | 1 |
...
| `crates/notagent/PARITY.md:913` | `src/cli/experimental/` | ausgeschlossen | 8 |
| `crates/notagent/PARITY.md:910` | `src/core/extensions/` | ausgeschlossen | 5 |
| `crates/notagent/PARITY.md:913` | `src/bun/` | ausgeschlossen | 3 |
| `crates/notagent/PARITY.md:910` | `src/extensions/` | ausgeschlossen | 3 |
| `crates/notagent/PARITY.md:437` | `src/core/modes/builtin/auto/10-*.md` | verifiziert | 1 |
| `crates/notagent/PARITY.md:437` | `src/core/modes/builtin/manual/10-*.md` | verifiziert | 1 |
| `crates/notagent/PARITY.md:437` | `src/core/modes/builtin/plan/10-*.md` | verifiziert | 1 |
| `crates/notagent/PARITY.md:437` | `src/core/modes/builtin/yolo/10-*.md` | verifiziert | 1 |
