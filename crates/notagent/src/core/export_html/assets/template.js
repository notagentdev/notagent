    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="notagent-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="notagent-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'notagent-share:v1:sidebar-width';
