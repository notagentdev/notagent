//! Success and error pages of the OAuth callback server.
//!
//! 1:1 port of `packages/ai/src/auth/oauth/oauth-page.ts` (109 LOC). Markup and styles
//! are taken over verbatim so the browser sees the same page.
